...
- Clone this repo to your local machine
  -  `git clone git@github.com:tarikbouari/Bookstore.git`
  - Open the folder "Bookstore `npm install` to install all necesary scripts,
...
**cd into Bookstore folder, then run from your terminal:**
